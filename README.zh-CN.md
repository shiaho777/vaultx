...
VaultX 是一个纯本地的安卓加密保险库。图片、视频、音频、任意文件乃至整棵目录树在导入时即被加密，并从系统相册和文件管理器中彻底消失。无账号、无网络权限、无需 root、无云端——所有数据只存在于应用私有存储中，密钥由你的密码派生。
...
<table>
  ...
  <tr>
    <td align="center"><sub>模式选择</sub></td>
    <td align="center"><sub>加密缩略图</sub></td>
    <td align="center"><sub>图片查看器</sub></td>
    <td align="center"><sub>音频播放器</sub></td>
  </tr>
</table>
...
完整威胁模型与诚实披露见 [SECURITY.md](SECURITY.md)——包括 VaultX **不**防护的场景。
...
<table>
  ...
  <tr>
    <td align="center"><sub>新建库 · 强度条</sub></td>
    <td align="center"><sub>解锁</sub></td>
    <td align="center"><sub>库根目录</sub></td>
    <td align="center"><sub>导入菜单</sub></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center"><sub>列表视图</sub></td>
    <td align="center"><sub>多选模式</sub></td>
    <td align="center"><sub>条目操作</sub></td>
    <td align="center"><sub>排序</sub></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center"><sub>跨目录搜索</sub></td>
    <td align="center"><sub>文本预览</sub></td>
    <td align="center"><sub>库设置</sub></td>
    <td align="center"><sub>临时空间</sub></td>
  </tr>
</table>
...
Release 默认不签名；使用自己的 keystore 通过 `assembleRelease` 签名。
